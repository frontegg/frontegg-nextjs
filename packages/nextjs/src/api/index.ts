...
import { fronteggTenantsV3Url, fronteggUsersUrl, ILoginResponse, GetCurrentUserTenantsResponse } from '@frontegg/rest-api';
 ...
 * @param headers
 */
export const getTenants = async (headers: Record<string, string>): Promise<GetCurrentUserTenantsResponse | undefined> => {
  const res = await Get({
