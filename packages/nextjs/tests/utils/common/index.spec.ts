...
test.describe('utils', () => {
  ...
  test('chunkString should return array of one string if chunk size is bigger then string size', () => {
    const chunkSize = 9;
    const string = '123456';
  ...
  test('chunkString should return array of strings with the right chunk size and also last item if his size is not equal to chunk size', () => {
    const chunkSize = 3;
